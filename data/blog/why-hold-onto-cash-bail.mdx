...
Illinois pretrial practice before the PFA. For instance, we’ve found that cash bail resulted in <a href="https://loyolaccj.org/pfa/blog/how-much-pretrial-detention-does-cash-bail-buy">much less
pretrial detention</a> than most people assume. While it’s true that many people were admitted to jail
under the old system, <a href="https://loyolaccj.org/pfa/blog/cash-bail-but-for-how-long">few remained there more than a few days</a>.
...
- <em> A practical substitute for preventive detention.</em> While pre-PFA law afforded prosecutors a way
...
-  <em> A useful mechanism to collect fees, fines, and restitution.</em>  In addition to its other uses, cash bail
...
collection steps. According to <a href="https://ilcourtsaudio.blob.core.windows.net/antilles-resources/resources/ec87b403-6f59-485a-a78d-12caf1cf92f8/Financial%20Impact%20Eliminating%20Cash%20Bail%20Report.pdf">research performed for the Illinois Supreme Court Pretrial
Implementation Task Force </a>, about four of every five dollars posted each year (more than {`$110`}
...
-  <em> A vital part of the system of accountability.</em>  Although bail is not a fine, and pretrial detention is
